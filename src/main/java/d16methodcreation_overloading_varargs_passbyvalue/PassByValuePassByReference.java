...
public class PassByValuePassByReference {
    public static void main(String[] args) {
        ...
        //Java değişken ve objelerin adreslerinin kopyalarında çalışır.
        //Java kopyada işlem yapar çünkü garanticidir. orjinali her ihtimale karşı korur.
        ...
        */
        ...
        // burda x ve y nin copyaları methoda gönderilir metod içinde bu sayılar ile oynansa bile orjinal değer değişmez
        //özetle java orjinal üzerinde oynanmasına izin vermez
        //non-primitive verilerde kopyası alınan şey adrestir.
