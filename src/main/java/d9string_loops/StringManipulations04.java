...
public class StringManipulations04 {
    public static void main(String[] args) {
        ...
        */
        ...
        //String str1 ="Merhaba" bu farklıdır aşağıdaki new ile üretmekten çünkü new her zaman memory de yeni bir alan
        //oluşturur.
        ...
        //adreslerine baktı ve karşılaştırdı
        //bu yüzden stringlerin karşılaştırılmasında eşit eşit kullanmayız
        System.out.println(str1.equals(str2)); //true  // içeriğe baktı
        //adresleri değil içerikleri karşılaştırdı
        System.out.println(str1 == str3);//true //aynı adreste oturan kardeşler
