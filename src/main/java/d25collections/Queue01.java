...
public class Queue01 {
    public static void main(String[] args) {
        ...
        // Kuyruk boşsa bir exception( istisna) fırlatır.
       ...
       //5)poll(): Kuyruğun başındaki öğeyi kuyruktan kaldırır ve döndürür. Kuyruk boşsa null döner.
        ...
        System.out.println(storage.poll());//null  /çünkü az önceki clear methodunda kuyrupu tamamen temizledim
     ...
     // emergencyQueue.add(null); HATA /acaba kuyrukta kimse kalmadı da mı null döndü yoksa bi eleman null da o  elamana
        //denk geldi demi null döndü. burda karışıklık olur java bbunun önüne geçmek için queue da null a izin vermiyor
        //eğer linkedlist kullanırsak da if ler ile o nulları ı elememiz lazım.
        ...
        //contrtuctor tarafında baktık LinkedListed dolayı insert sırası oluşmuştur.
