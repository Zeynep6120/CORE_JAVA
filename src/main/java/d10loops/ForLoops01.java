...
public class ForLoops01 {
    public static void main(String[] args) {
        ...
        //------------------------------
        //Ornek 2: 20 (dahil) den 3 (dahil) e kadar tüm tamsayilari console'a yazdiriniz.
        ...
        System.out.println("----------------------------");
        //------------------------------
        //Ornek 3: 3'den 20'ye kadar tüm çift sayilari console'a yazdiriniz(20 dahil)
        //Example 3: Write all even numbers from 3 to 20 to the console(including)
