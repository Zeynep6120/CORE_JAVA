...
public class StringManipulations03 {
    public static void main(String[] args) {
     ...
     /*Ornek 1: Asagidaki kurallara gore kullanicinin girdigi password'u kontrol ediniz.
        ...
        System.out.println("Lütfen şifreninizi giriniz");
        ...
        //[^ ] buda bir kere boşluğa bastım bu ifade boşluk hariç demek
        //kodlama da istemediğiniz şeyi 0 a eşitlersiniz.

        //boolean spaceControl = pwd.replaceAll("[^ ]", "").isEmpty();
        // isEmpty() de ikinci yol bir boşluk var mı kontrolu için
        ...
        //Odev en az bir tane sembol içermeli...
