...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(s3);// Learn Jave earn **** money
        //bunu replace metodu ile yapamazsınız çünkü replace metodu regex destedklemiyor.
        ...
        // Java da bir şeyi saymak istersek diğerlerini sileriz

        int num = s.replaceAll("[^0-9]","").length();
        //rakamları saymak için rakam hariç her şey sildim.boşlukarıda siler.
        //length() 1 den başlayarak karakterleri sayar.
