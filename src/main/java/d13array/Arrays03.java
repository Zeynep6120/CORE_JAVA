...
public class Arrays03 {
    public static void main(String[] args) {
        ...
        //java buna tekli veri gözüyle bakar ve daha hızlı oluşturur.öncekinde ayrı ayrı veri
        //gözüyle bakar ve daha yavaş oluşturur.
        ...
        System.out.println(result); // B'nin indexini verdi yani 1

        result = Arrays.binarySearch(names, "C");
        System.out.println(result); // C için -3 verdi .bu şu demek olsaydı kacinci sirada olurdu
        ...
        String s1 = "Java is easy. Learn java earn money."; //Java is easy. Learn java earn money.
        ...
        //biz split methodu ile bir stringi böldüğümüz zaman ortaya çoklu bir veri çıkar.
