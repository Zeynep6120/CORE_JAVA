...
public class Arrays02 {
    public static void main(String[] args) {
        ...
        //1.yoll----------------------------------
        //Arrays yardımcı classının içinde sort methodu var.
        Arrays.sort(ages);
        System.out.println(Arrays.toString(ages));//[15, 19, 20, 23, 32, 44]

        System.out.println(ages[0] + ages[ages.length - 1]);//[15, 19, 20, 23, 32, 44]  //59
        ...
        //mininum ve maximum sorularında sıfırıncı index minimum veya maximum olarak kabul edilir.
        //bu işle sıfırıncı indexin içindeki veriye bakmadan kabul edilir.
        ...
        System.out.println(" Toplam = "+(minimum+maksimum));
