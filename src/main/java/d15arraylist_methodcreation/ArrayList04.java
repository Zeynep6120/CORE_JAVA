...
public class ArrayList04 {
    public static void main(String[] args) {
        ...
        //bir list oluşturmak için kısayol
        List<Integer> myList = Arrays.asList(1, 3, 4, 9, 7);
        System.out.println(myList);
        //asList kullanrak bir list i kısa yol ile doldurabiliriz .add methodu kullanmamıza gerek kalmaz
        //bu metodu kullanırsak listeye daha eleman ekleyip çıkaramayız
        ...
        //oldu çünkü eleman sayısını değiştirmedik elemanı değiştirdik
