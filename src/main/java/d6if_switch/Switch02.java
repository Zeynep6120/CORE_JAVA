...
public class Switch02 {
    public static void main(String[] args) {
        ...
        */
        ...
        //boolean olmaz çünkü sadece iki tane seçeneği var.long olmaz çünkü long sayı olarak çok büyük  bir değer 8 byt
        //yani 64 bit çok büyük bu da yüksek bellek kullanımı yapıp düşük performansa sebep olabiliyor.




        Scanner input = new Scanner(System.in);
        System.out.println("Lütfen başlangıç ay sayisini giriniz");
