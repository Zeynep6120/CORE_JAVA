...
public class Md01 {
    public static void main(String[] args) {
        ...
        //iç içe array olunca toString methodu ile yazdıramayız
        ...
        //MultiDimensional Array içindeki bir Arrayt nasil yazdirilir?
        System.out.println(Arrays.toString(a[2]));//[123, 0]

        //Kisa yoldan MultiDimensional Array nasil oluşturulur?
        ...
        //----------------------------------
        //Ornek 1: Yukardaki students array'inde toplam kaç isim oluduğunu bulunuz.
        //Example 1:Find the total number of names in the students array above.

        int sum = 0;
        //çok lu verilerin içinde for  döngüsü ile dolaşılır.
        ...
        //Ornek 2: Yukarıdaki students Array'inde içinde 'm' olan isimleri console'a yazdiriniz.
        //Example 2: Write the names with "m" in the students Array to the console
        //çokludan tek array' e array dan direkt data ya ulaştık aşağıdaki for döngüsünnde
