...
public interface Engine {
    ...
    interfacelerin yoktur ama abstract class ların constroctor i vardır.
    2) interface’ler sadece parent olur
    //ama bir interface sadece kendi türünden bir interface in ancak childı olabilir
    //abstract class normal bir class ın child ı olabilir.
    ...
    */
    ...
    fakat interface’ler varsayilan olarak abstract method icerir.
       ...
       //yani bodyli method oluşturabliriz demek
    ...
    */
    ...
    //public static final default olarak olduğu için yazmasakda olur

    int price = 2000;

    int fiyat = 300;

    default void power(){//burdaki default acces modifer değil sadece keyworddur
        System.out.println("200HP");
    }
    static void speed(){
        System.out.println("Saatte 300 km ");
    }
    //static ve default keywordunü interface icine bodyli bir method eklemek için kullanırız
}