...
public abstract class Honda {
    ...
    //omurgalilar class ı bir obje üretmez hayvanlar class ı bir obje üretmez sıcakkanlılar classı
    //bir obje üretmez obje daha altarda ortaya çıkıyor mesela kuşlar sınıfında olan serçe obje üretur
    //yani abstract class sadece sınıflandırma için vardır abstract classlardan obje üretemeyiz
    */
    ...
    */
    ...
    //final methodlar overide edilemediği için abstract olamaz
