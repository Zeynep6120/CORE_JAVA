...
public class Operators {
    public static void main(String[] args) {
         ...
         */
        // buyükten kasit daha fazla yer kaplaması mesela int ve long ile işlem yapıyorsanız sonuç long türünde olur
        // çünkü long memory de daha fazla yer kaplar

        int amountOfMoney1 = 25;
        int numberOfPeople1 = 10;
        System.out.println(amountOfMoney1 / numberOfPeople1); //2 çıktı. 2.5 çıkmalıydı. Java .5 'i sildi

        double amountOfMoney2 = 25; // 8 byte ondalikli sayi
        int numberOfPeople2 = 10;   // 4 byte tamsayi
        // Büyüklükten kasit, daha fazla bilgi depolamasidir
        System.out.println(amountOfMoney2 / numberOfPeople2); // 2.5
        // double 8 byte oldupundan yani daha fazla bilgi depolayabileği için sonuç double türünden çıktı
