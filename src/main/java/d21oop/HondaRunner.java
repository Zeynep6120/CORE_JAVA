    ...
    public static void main(String[] args) {
       ...
       Cevap : child’da bir constructor icinde, super yazip parantez koymadan,
        ...
        //constructorlar bu sıra ile çalışır.
            ...
            //Burda Yaptığımız şey ben child class tan bir obje üretiyorum ama parent class lardan obje üretmiyorum.
        //Fakat parent classın özelliklerini de miras yolu ile bu öbjede kullanabiliyorum.super çağrısi miras yolu ile
        //çağrıyoruz ve bu özellikleri child a aktariyoruz.Yani her class tan tek tek obje üretmemiş oluyoruz.
    }
}
