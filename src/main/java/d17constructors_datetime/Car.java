...
public class Car {
    ...
    //şimdi class tan obje üretebilmek için main oluşturucaz.
    ...
    //default constructor hep aynı ürünü üretir.

    /*7- Constructor nasil olusturulur?
    Access Modifier + Class ismi + () + {}
    Kendiniz constructor’inizi olusturdugunuz zaman Java default constructor’i siler

    !!!!!!INTERVİEWWWW SORUSU***Method ile Constructor arasindaki fark nedir? (Interview Sorusu)
    ...
    //Bir constructor static olmaz çünkü staticten obje üretilmez non-staticten obje üretiriz.
    ...
    */
    ...
    //14- Farklı parametreli constructor oluşturalım
    ...
    //15- CarRunner'a gidip bu constructor'lari kullanalım
