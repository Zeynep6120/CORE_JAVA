...
public class DoWhileLoops02 {
    public static void main(String[] args) {
        ...
        */
        ...
        int counter = 0;// Kalan hak kontrolü yapmak için ekledik counter 4 olduğunda "Hesabınız bloke olmuştur
                        // şeklinde mesaj verilecek.

        do{
            if(counter == 4){
                System.out.println("Hesabını Bloke olmuştur");
                break;
            }
            ...
            System.out.println("Lütffen password giriniz");
        ...
        }while(true); // while 'ın içine true yazar isek sonsuz döngüye sokmuş oluruz.
                    // sonsuz döngüye sokturk, içerden kırılmadığı sürece çalışacak.


        // ODEVVVV!!!!!!!
        //Kalan hak sayısını göstermek istesek kod nasil olurdu?
