...
public class E08 {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        // FileInputStream bu verile yola gidip dosyayı bulamaz isem exceptionu.sen bana bir yol verdin ama
        // ben run sırasında gittiğimde bu dosyayı bulamaz isem diyor java bu hatayı vererek

        int k = 0;
        //IO exception dosya bulunamamasını da okunamamasını da kapsar.filennotfound exceptionun parentı IO exceptiondur
        //o yüzden ayrı ayrı yazmadık bir tek IO exception yazdık
        while ((k = fis.read()) != -1) {
            System.out.print((char)k);//type casting yaptıık//java kolaydır
        }
    }
}
