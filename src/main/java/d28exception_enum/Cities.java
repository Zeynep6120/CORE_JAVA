...
public enum Cities {
    ...
    */
    ...
    //enum yapılarında set methodu yoktur çünkü set dışardan ulaşıp değiştirmek demektir.biz
    //bir enum yapısına dışardan ulaşıp değiştiremeyiz ki.dışardan okuma yapabiliriz enum yapılarında mesela gelip
    //bursanın plakasını okuyabiliriz ama değiştiremeyiz.
}
