...
//-----------------------------------------------------------------------------
    ...
    //Ay tüm ülkeler için ortaktır bir ülke gidip aya resım çizemez çünkü tüm ülkelerin hakkı var
    //STatic methodlar buna benzer.yani kafama göre ayı değiştiremem .bu yüzden statik methodlarda da değişim yapamam
    //yani statik methodlar override edilemez
    //Java static methodların override edilemsine müsade etmez.bir kişi çıkıp ben Tc kimlik numaramı değiştirdım diyemez
    //çünkü tüm child classlar yani ssk emniyet hastane hep bundan etkilenirdi yani tc kimlik değişmez
...
//ama static methodlar overload edilebilir.
    //---------------
...
//final bir class chid sahibi olamaz.final ile etkinen bir classın childı olmaz yani Animal classını final ile etkitlersek
    //reddeder.
    ...
    public void eat() {
        ...
        //final bir vairable a yeni değer yada assign yapılamaz.
        //yani final bir variable a yeni değer atanamaz.
    }
