...
/*Ornek 1: Kullanicidan gun sayisini aldiginizda gun ismini yazan kodu yaziniz
        ...
        int num = (int) numDouble; //Type casting yapti.atıyorum siz 3,4 girdiniz type casting ile noktadan sonraki kısmı
        //kesip attı. yani ondaliklı sayıyı tam sayıya çevirdi.

        if(numDouble != num) {
            System.out.println("Lütfe bir tam sayı giriniz");
