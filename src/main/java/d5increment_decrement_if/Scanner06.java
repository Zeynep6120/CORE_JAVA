...
public class Scanner06 {
    public static void main(String[] args) {
        ...
        int age = scanner.nextInt();//sayisal bir input aldık

        scanner.nextLine(); // Kullanılmayan yeni satır karakterini okuyup atar.

        System.out.println("Adininiz giriniz");
        String name = scanner.nextLine();//Çalıştırılınca bu satır atlanacak
        //buna yeni satır karakteri hatası deniyor.
