...
public class Sb03 {
    public static void main(String[] args) {
        ...
        System.out.println(result); // Z=90, K=75  bize ikisi arasındaki farkı gösterecek yani 15 i verdi.

        //---------------------
        //7-toString() metodu, StringBuilder nesnesinin içeriğini bir String nesnesine dönüştürür.
        //bu sayede string methodlarını kullanabilcez.
        ...
        //-----------------------------------------------------
        //StringBuffer nasil oluşturulur.
        ...
        //çoklu iş parçacığı aynı anda çoklu işleme yapabiliyor demek.bankada bir çok memurun aynı anda çalışması gibi
        //yani banka aynı anda bir çok iş yapıyor.aynı anda paralel işleme deniyor yani diğer işler birbirini engellermiyor.
        ama StringBuilder "multi-thread" degildir.
        4) StringBuilder "multi-thread" olmadigi icin StringBuffer’dan daha hizli calisir
        5) Multi-thread yapilirken, yapilan islerin siralamasi onem arzeder. Yapilan isleri mantikli bir*********önemli
